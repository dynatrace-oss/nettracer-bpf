...
const std::array<BpfDebugCounterField, kBpfDebugCountersFieldCount>& bpfDebugCounterFields() {
	static const std::array<BpfDebugCounterField, kBpfDebugCountersFieldCount> fields = {{
			...
			{"perf_output_ipv4_on_connect_attempt_failures", &BpfDebugCounters::perf_output_ipv4_on_connect_attempt_failures},
			{"perf_output_ipv6_on_connect_attempt_failures", &BpfDebugCounters::perf_output_ipv6_on_connect_attempt_failures},
